...
if __name__ == '__main__':
    ...
    # test
    line = '<bos> age_15-29 <sep> F <sep> douleurxx_carac lancinante_/_choc_électrique douleurxx_irrad_@_sous_la_machoire douleurxx_irrad_@_sous_la_machoire douleurxx_irrad_@_sous_la_machoire <eos> <pad>'.split(' ')
